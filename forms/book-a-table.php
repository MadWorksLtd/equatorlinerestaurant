<?php
  ...
  * For more info and help:johnmagala12345@gmail.com php-email-form/
  */

  // Replace equatorlineuganda@gmail.com with your real receiving email address
  $receiving_email_address = 'equatorlineuganda@gmail.com';

  if( file_exists($php_email_form = 'forms\book-a-table.php')) {
